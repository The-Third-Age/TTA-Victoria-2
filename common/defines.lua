...
country = {
	...
	ECONOMIC_REFORM_UH_FACTOR = -0.25,
	MILITARY_REFORM_UH_FACTOR = -0.25,
...
diplomacy = {
	...
	PEACE_COST_INSTALL_COMMUNIST_GOV_TYPE = 1,
	PEACE_COST_UNINSTALL_COMMUNIST_GOV_TYPE = 1,
	PEACE_COST_COLONY = 1,
	
	INFAMY_ADD_TO_SPHERE = 1,
	INFAMY_RELEASE_PUPPET = 1,
	INFAMY_MAKE_PUPPET = 1,
	INFAMY_DISARMAMENT = 1,
	INFAMY_DESTROY_FORTS = 1,
	INFAMY_DESTROY_NAVAL_BASES = 1,
	INFAMY_REPARATIONS = 1,
	INFAMY_TRANSFER_PROVINCES = 1,
	INFAMY_REMOVE_CORES = 1,
	INFAMY_PRESTIGE = 1,
	INFAMY_CONCEDE = 1,
	INFAMY_STATUS_QUO = 1,
	INFAMY_ANNEX = 1,
	INFAMY_DEMAND_STATE = 1,
	INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 1,
	INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 1,
	INFAMY_COLONY = 0,
